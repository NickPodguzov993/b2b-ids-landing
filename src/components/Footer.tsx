                ...
                <div
                    ...
                    <div className="self-stretch h-[334px] flex-col justify-start items-center gap-8 flex">
                        <div
                            ...
                            <div
                                className="w-[500px] self-stretch flex-col justify-start items-start gap-8 inline-flex">
                                <div className="pb-0.5 justify-center items-center gap-2.5 inline-flex">
                                    <div
                                        className="text-white text-[64px] font-medium font-['Oswald'] uppercase">info@name.com
                                    </div>
                                </div>
                                <div className="pb-0.5 justify-center items-center gap-2.5 inline-flex">
                                    <div
                                        className="text-white text-[64px] font-medium font-['Oswald'] uppercase">+357-хх-ххх-ххх
                                    </div>
                                </div>
                            </div>
                            <div className="self-stretch flex-col justify-between items-end inline-flex">
                                <div className="w-[185px] p-4 justify-start items-center gap-2.5 inline-flex">
                                    <div className="text-[#e8eaed] text-base font-bold font-['Arial']">Policies</div>
                                </div>
                                <div className="w-[185px] p-4 justify-start items-center gap-2.5 inline-flex">
                                    <div className="text-[#e8eaed] text-base font-normal font-['Arial']">Terms and
                                        conditions
                                    </div>
                                </div>
                                <div
                                    className="w-[185px] h-14 px-8 py-4 bg-[#4cffa9] rounded-[20px] justify-center items-center gap-2.5 inline-flex">
                                    <div className="text-black text-base font-normal font-['Arial']">Text</div>
                        ...
                        <div className="self-stretch justify-between items-center inline-flex">
                            <div
                                className="w-[330px] text-[#e8eaed] text-sm font-normal font-['Arial'] leading-snug">Dolor
                                ut. Sit vestibulum est. Sit hac dictumst. Sit faucibus. Tempus habitasse urna platea
                                lore.
                            </div>

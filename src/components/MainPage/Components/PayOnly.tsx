...
const PayOnly = () => {
    return (
        <div className='mt-[120px] '>
            ...
            <div className="text-[#1b1b1b] text-base font-normal p-4 font-['Arial']">To create and submit a
                personalized
            ...
            {/* <div className='border-l-2 border-r-2'>
                        ...
                        <div className="bg-[#e8eaed] mt-[20px]  relative">
                            <div className="self-stretch  px-2 flex-col justify-start items-start gap-3 flex">
                                ...
                                <div className="self-stretch text-black text-xl font-normal font-['Arial']">The cost is
                                    based on
                                    needs
                                </div>
                                <div
            ...
            <div className="w-[343px] h-[701px] flex-col ml-4 justify-start items-start gap-8 inline-flex">

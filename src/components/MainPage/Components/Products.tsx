    ...
    return (
        <div>
            <div className='hidden sm:block ml-[132px]'>
                <div
                    ...
                    <div
                        ...
                        <div className="text-black text-base font-normal font-['Arial']">About product</div>
                    </div>
                    <div
                        className="self-stretch text-center text-black text-9xl font-medium font-['Oswald'] uppercase">Our
                        Offers
                    </div>
                </div>
                ...
                <div
                    ...
                    <div className="w-[622px]  flex-col justify-start items-start gap-2.5 inline-flex">
            ...
            <div className='sm:hidden'>
                ...
                <div
                    className="w-[360px] h-24 px-4  rounded-[20px]  justify-start items-center gap-2 inline-flex flex-wrap">
                ...
                <div className="bg-[#e8eaed] rounded-[20px] p-4">
                    ...
                    <div className="self-stretch  flex-col justify-start items-start gap-4 flex">
                        ...
                        <div
                            className="self-stretch text-black text-2xl font-medium font-['Oswald'] uppercase pt-3">Billing
                            allows you to:
                        </div>
                        <div className="self-stretch h-[174px] flex-col justify-start items-start gap-2.5 flex">
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
                                ...
                                <div
                                    className="grow shrink basis-0 text-black text-base font-normal font-['Arial']">Access
                                    a list of available payment methods
                                </div>
                            </div>
                            <div className="self-stretch justify-start items-center gap-2 inline-flex">
